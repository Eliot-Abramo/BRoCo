...
#include "../include/RocoRos/MessageBus.h"
...
#include "../include/RocoRos/Protocol/ProtocolRegisters.h"
	...
	while(length > 0) {
		...
		if(copy_length == remaining_size) { // Packet is complete
			...
			if(handlers[packet_id & 0b00111111] != nullptr) {
				handlers[packet_id & 0b00111111](sender_id, indexable_buffer->buffer + 2, publishers[packet_id & 0b00111111]);
			}
